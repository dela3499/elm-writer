...
var _user$project$WordCounter$countWords = function (string) {
...
var _user$project$WordCounter$formatTime = function (seconds) {
	var nMinutes = _elm_lang$core$Basics$floor(seconds / 60);
	var nSeconds = _elm_lang$core$Basics$floor(
		seconds - _elm_lang$core$Basics$toFloat(nMinutes * 60));
	var secondsString = (_elm_lang$core$Native_Utils.cmp(nSeconds, 10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString(nSeconds)) : _elm_lang$core$Basics$toString(nSeconds);
	var minutesString = _elm_lang$core$Basics$toString(nMinutes);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		minutesString,
...
var _user$project$WordCounter$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Time$every,
		100 * _elm_lang$core$Time$millisecond,
		function (x) {
			return _user$project$WordCounter$Tick(
				_elm_lang$core$Time$inSeconds(x));
		});
};
var _user$project$WordCounter$SetContent = function (a) {
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$placeholder('Type in here!'),
						_elm_lang$html$Html_Events$onInput(_user$project$WordCounter$SetContent)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('infoContainer')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$WordCounter$formatTime(model.secondsElapsed))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('wordcount')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
...
var _user$project$WordCounter$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$WordCounter$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
			view: _user$project$WordCounter$view,
			update: _user$project$WordCounter$update,
			subscriptions: _user$project$WordCounter$subscriptions
		})
};

var Elm = {};
Elm['WordCounter'] = Elm['WordCounter'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['WordCounter'], 'WordCounter', typeof _user$project$WordCounter$main === 'undefined' ? null : _user$project$WordCounter$main);
